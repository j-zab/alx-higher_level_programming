...
class Base:
    ...
    def __init__(self, id=None):
        """Method that assigns e` public instance attribute id
        Args:
           id(int): integers value that manages the id in the project
        Return:
           Always null
        """
        if id is not None:
    ...
    def to_json_string(list_dictionaries):
        """This Method returns the JSON
           str representation
        Args:
           list_dictionaries(dict): List of dictionaries in the str
        Return:
           The JSON string
        """
    ...
    def save_to_file(cls, list_objs):
        """ This Method writes the JSON str representation
    ...
    def from_json_string(json_string):
        """The Method returns the list of the
    ...
    def load_from_file(cls):
        """The Method returns a list of instances
           - the type of these instances depends on class
        """
        filename = "{}.json".format(cls.__name__)
        instance_list = []
        try:
    ...
    def draw(list_rectangles, list_squares):
        """The Method draws the shape with turtle module
        Args:
           list_squares(list): Lists square objects
           list_rectangles(list): Lists rectangle objects
        Return:
           Nothing Always
        """
